...
namespace WebAppLocalSIS2420.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdUsuario,NombreCompleto,Email,Password,Rol")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdUsuario,NombreCompleto,Email,Password,Rol")] Usuario usuario)
        {
